		...
		<div class="page error-bg">
			<div class="page-content m-0">
				<div class="container text-center">
					...
					<h1 class="h3  mb-3 font-weight-semibold">Access Denied</h1>
					<p class="h5 font-weight-normal mb-7 leading-normal">It Seems Like You Are Not Authorized To Access This Page</p>
				</div>
			</div>
		</div>
		<!--Row-->
