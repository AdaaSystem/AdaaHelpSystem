                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu custom-ul">
                        ...
                        @can('Onhold Tickets')
                            ...
                            <li><a href="{{route('admin.onholdticket')}}"
                                   class="slide-item"> {{trans('langconvert.adminmenu.onholdtickets')}} </a></li>
                        @endcan
                        @can('Overdue Tickets')

                            <li><a href="{{route('admin.overdueticket')}}"
                                   class="slide-item"> {{trans('langconvert.adminmenu.overduetickets')}}</a></li>
                        @endcan
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu custom-ul">
                        ...
                        @can('FAQs Access')
                            ...
                            <li><a href="{{url('/admin/faq')}}" class="slide-item">{{trans('langconvert.menu.faq')}}</a>
                            </li>
                        @endcan
