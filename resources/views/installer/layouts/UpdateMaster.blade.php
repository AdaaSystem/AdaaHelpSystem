    ...
    <body>
        <div class="master">
            <div class="box">
                ...
                <div class="copyright"> Copyright © {{date('Y')}} <a href="javascript:void(0);">AdaaHelp</a>. Developed by <a href="javascript:void(0);"> Smart Team Pvt.Ltd. </a> All rights reserved </div>
            </div>
        </div>
    </body>
</html>